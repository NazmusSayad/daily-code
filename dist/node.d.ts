 ...
 * ```
 */
declare function applyNodeMD4Issue(): void;
 ...
 */
declare function execPwshCommand(command: string): string;
/**
 ...
 *   readEnv('PATH', 'User')
 */
declare function readEnv(name: string, scope: Scope): string;
/**
 ...
 */
declare function writeEnv(name: string, value: string, scope: Scope): string;
/**
 ...
 */
declare function addToEnvPath(scope: Scope, ...paths: string[]): string;

...
function createContext(useValue, options) {
    ...
    const nativeContext = React__namespace.createContext(options?.initialValue);
    nativeContext.displayName = displayName;
    function useContext() {
        if (options?.useContextHandler) {
            return options.useContextHandler(nativeContext);
        }
        const context = React__namespace.useContext(nativeContext);
    ...
    function ContextProvider({ children, ...props }) {
        ...
        const providerChildren = options?.useProvider
            ...
            : children;
        return (jsxRuntime.jsx(nativeContext.Provider, { value: providerValue, children: providerChildren }));
    }
...
exports.createReactSuspense = createReactSuspense;
exports.useEffectExceptOnMount = useEffectExceptOnMount;

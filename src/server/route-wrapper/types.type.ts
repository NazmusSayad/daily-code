...
export type RouteHandler<TParams extends unknown[]> = (
  ...args: TParams
) => void | Promise<void>

export type CatchHandler<TParams extends unknown[]> = (
  err: Error,
  ...args: TParams
) => unknown

export type FinisherHandler<TParams extends unknown[], TReturn = unknown> = (
